  ...
  parseNFADescription() {
    ...
    this.readline.question(statesPrompt, answer => {
      ...
      this.readline.on('line', transition => {
        ...
        //   console.log('transitionSymbol', transitionSymbol);
  ...
  parseTMDescription() {
    ...
    this.readline.question(statesPrompt, answer => {
      ...
      this.readline.on('line', transition => {
        ...
        console.log('symbolSplit::', symbolSplit);
        console.log('transitionOpsSplit::', transitionOpsSplit);
        if (symbolSplit.length !== 2) {
          return this.handleInvalidFormat();
        }
        ...
        console.log('this.tapeAlphabet:', this.tapeAlphabet);
        ...
        console.log('this.alphabet', this.alphabet);
        console.log('this.states', JSON.stringify(this.states, null, 2));
      });
    });
  }
